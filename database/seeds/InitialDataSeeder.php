...
class InitialDataSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('fields')->insert([/* id => 7 */'name' => 'Galones comprados', 'type' => FieldTypeEnum::NUMBER, 'placeholder' => 'No', 'rules' => 'required']);
        DB::table('fields')->insert([/* id => 8 */'name' => 'Horas de uno?', 'type' => FieldTypeEnum::NUMBER, 'placeholder' => 'No', 'rules' => 'required']);
