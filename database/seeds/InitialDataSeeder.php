...
class InitialDataSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('fields')->insert([/* id => 1 */'name' => 'Peligrosos', 'type' => FieldTypeEnum::NUMBER, 'placeholder' => 'Kg', 'rules' => 'required']);
        DB::table('fields')->insert([/* id => 2 */'name' => 'Orgánicos', 'type' => FieldTypeEnum::NUMBER, 'placeholder' => 'Kg', 'rules' => 'required']);
        DB::table('fields')->insert([/* id => 3 */'name' => 'Plásticos', 'type' => FieldTypeEnum::NUMBER, 'placeholder' => 'Kg', 'rules' => 'required']);
        DB::table('fields')->insert([/* id => 4 */'name' => 'Otros', 'type' => FieldTypeEnum::NUMBER, 'placeholder' => 'Kg', 'rules' => 'required']);
        ...
        DB::table('fields')->insert([/* id => 7 */'name' => 'Galones comprados', 'type' => FieldTypeEnum::LONG_TEXT, 'placeholder' => 'No', 'rules' => 'required']);
        DB::table('fields')->insert([/* id => 8 */'name' => 'Horas de uno?', 'type' => FieldTypeEnum::LONG_TEXT, 'placeholder' => 'No', 'rules' => 'required']);
